...
def parse_arguments(raw_args=None):
    ...
    parser.add_argument(
        '--data',
        default='sensitive_from_numpy',
        help=f'Dataset {default_str}',
        choices=['sensitive_from_numpy', 'toy_data_1d', 'toy_data_1d_multitask'],
    )
    parser.add_argument('--lr', default=0.01, help=f'Learning rate {default}', **float_type)
    ...
    parser.add_argument(
        '--manual_seed', **int_type, help='manual seed, if not given resorts to random seed.'
    )
    parser.add_argument(
        '--save_best',
        default=False,
    ...
    parser.add_argument(
        '--inf',
        default='Variational',
        help=f'Inference method {default_str}',
    ...
    parser.add_argument(
        '--p_ybary0_or_ybary1_s0',
        default=1.0,
        **float_type,
        help=('Determine how similar the target labels' 'are to the true labels for s=0'),
    )
    parser.add_argument(
        '--p_ybary0_or_ybary1_s1',
        default=1.0,
        **float_type,
        help=('Determine how similar the target labels' 'are to the true labels for s=1'),
    )
    # Equalized Odds
