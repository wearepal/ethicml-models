...
def construct_model(flags):
    ...
    # Initialize model
    model: gpytorch.models.GP = GPModel(train_ds=train_ds, likelihood=likelihood, kernel=kernel,
                                        inducing_inputs=inducing_inputs, mean=mean, flags=flags)
    if flags.use_cuda:
